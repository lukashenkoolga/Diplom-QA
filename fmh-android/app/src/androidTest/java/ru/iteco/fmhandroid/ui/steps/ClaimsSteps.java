...
public class ClaimsSteps {
    ...
    public void isFilterWindow() {
        Allure.step("Проверка элементов окна Filter");
    ...
    public void clickAddComment() {
        Allure.step("Кликнуть кнопку добавления комментария");
    ...
    public void clickCommentEditBtn(int index) {
        Allure.step("Кликнуть кнопку редактирования комментария");
    ...
    public void checkCommentToClaim(String text) {
        Allure.step("Проверка отображения комментария");
