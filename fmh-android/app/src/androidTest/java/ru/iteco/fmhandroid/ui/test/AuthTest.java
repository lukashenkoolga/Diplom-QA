...
//            new ActivityTestRule<>(AppActivity.class);
    public androidx.test.rule.ActivityTestRule<AppActivity>
            activityTestRule = new ActivityTestRule<>(AppActivity.class);
    ...
    public void logoutCheck() {
        ...
        public void shouldNotLogInWithInvalidData () {
            ...
            authSteps.clickSignInBtn();
//            SystemClock.sleep(3000);
//            commonSteps.checkEmptyToast(ActivityTestRule.getActivity(), messageWrong);
            commonSteps.checkEmptyToast("Wrong login or password", activityTestRule);
